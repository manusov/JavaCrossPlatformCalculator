// Button and operation description class for "ARCSCH" button.
...
public class ButtonARCSCH extends CalcButton 
{
private final static String NAME = "arcsch";
private final static String TEXT = "Hyperbolic arccosecant";
private final static int[]  KEYS = null;
@Override public String getName() { return NAME; }
@Override public String getText() { return TEXT; }
@Override public int[] getKeys()  { return KEYS; }
@Override public void buttonAction(CalcCore cc) 
    { cc.opOneOperand(CalcOperations.ARCSCH); }
