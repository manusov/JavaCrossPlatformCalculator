// Button and operation description class for "X power 2" button.
...
public class ButtonX2 extends CalcButton 
{
private final static String NAME = "<html>X<sup>2";
private final static String TEXT = "X to the power of 2";
private final static int[]  KEYS = null;
@Override public String getName() { return NAME; }
@Override public String getText() { return TEXT; }
@Override public int[] getKeys()  { return KEYS; }
@Override public void buttonAction(CalcCore cc) 
    { cc.opOneOperand(CalcOperations.PX2); }
