// Button and operation description class for "ARTH" button.
...
public class ButtonARTH extends CalcButton 
{
private final static String NAME = "arth";
private final static String TEXT = "Hyperbolic arctangent";
private final static int[]  KEYS = null;
@Override public String getName() { return NAME; }
@Override public String getText() { return TEXT; }
@Override public int[] getKeys()  { return KEYS; }
@Override public void buttonAction(CalcCore cc) 
    { cc.opOneOperand(CalcOperations.ARTH); }
