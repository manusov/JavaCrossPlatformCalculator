...
Button and operation description class for "ARCTG" button.
...
public class ButtonARCTG extends CalcButton 
{
private final static String NAME = "arctg";
private final static String TEXT = "Arctangent";
private final static int[]  KEYS = null;
@Override public String getName() { return NAME; }
@Override public String getText() { return TEXT; }
@Override public int[] getKeys()  { return KEYS; }
@Override public void buttonAction( CalcCore cc ) 
    { cc.opOneOperand( CalcOperations.ARCTG ); }
