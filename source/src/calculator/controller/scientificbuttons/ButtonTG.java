...
Button and operation description class for "TG" button.
...
public class ButtonTG extends CalcButton 
{
private final static String NAME = "tg";
private final static String TEXT = "Tangent of the angle";
private final static int[]  KEYS = null;
@Override public String getName() { return NAME; }
@Override public String getText() { return TEXT; }
@Override public int[] getKeys()  { return KEYS; }
@Override public void buttonAction( CalcCore cc ) 
    { cc.opOneOperand( CalcOperations.TG ); }
