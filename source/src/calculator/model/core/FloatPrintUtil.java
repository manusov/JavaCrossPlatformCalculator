...
static String printCorrectedBigDecimal( BigDecimal bdX, boolean result )
    {
...
static String printCorrected( double x, boolean result )
    {
...
private final static int THRESHOLD_0 = 10;
// maximum number of enabled "9" digits after ".", otherwise round
private final static int THRESHOLD_9 = 10;
